...
Dù là ứng dụng cá nhân (single-user), hệ thống vẫn bảo mật bằng cơ chế chuẩn:
...
1. Kiểm tra xem bảng `users` đã có bản ghi nào chưa (Single-user constraint).
   - Nếu đã tồn tại → trả về 409 Conflict.
